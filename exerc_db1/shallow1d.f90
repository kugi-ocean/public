...
program main
  ...
  real(8)    :: x(0:im,0:1)               !- 変数 x(:,0) eta [m], x(:,1) u [m/s]
  real(8)    :: k1(0:im,0:1), k2(0:im,0:1), k3(0:im,0:1), k4(0:im,0:1)
  real(8)    :: t, dx_m, x_m
  integer(8) :: ii, n, nm
  ...
  open(10,file='shallow1d.dat',form='unformatted',access='stream')
  write(10) im, nm
  write(10) dx_m, dt_sec
  write(10) x
